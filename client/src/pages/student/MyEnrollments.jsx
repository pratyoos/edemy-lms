...
const MyEnrollments = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 0, totalLectures: 13 },
    { lectureCompleted: 3, totalLectures: 8 },
            ...
            {enrolledCourses.map((course, index) => (
              <tr className='border-b border-gray-500/20' key={index}>
                ...
                <td className='px-4 py-3 max-sm:text-right'>
                  <button className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 cursor-pointer max-sm:text-xs text-white' onClick={() => navigate('/player/' + course._id)}>
